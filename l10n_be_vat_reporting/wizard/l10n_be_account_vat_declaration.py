...
class VatDeclaration(models.Model):
    ...
    def _get_tax_code(self, cr, uid, context=None):
        ...
        tax_code_ids = obj_tax_code.search(
            cr, uid, [('company_id', '=', company_id), ('parent_id', '=', False)], context=context)
    ...
    def create_xml(self, cr, uid, ids, context=None):
        ...
        list_of_tags = ['00', '01', '02', '03', '44', '45', '46', '47', '48', '49', '54', '55', '56', '57',
                        '59', '61', '62', '63', '64', '71', '72', '81', '82', '83', '84', '85', '86', '87', '88', '91']
        ...
        tax_code_ids = obj_tax_code.search(
            cr, uid, [('parent_id', 'child_of', data_tax.tax_code_id.id), ('company_id', '=', obj_company.id)], context=context)
        ctx = context.copy()
        ...
        send_ref = str(obj_company.partner_id.id) + \
            str(account_period.date_start[5:7]) + str(account_period.date_stop[:4])
...
<ns2:VATConsignment xmlns="http://www.minfin.fgov.be/InputCommon" xmlns:ns2="http://www.minfin.fgov.be/VATConsignment" VATDeclarationsNbr="1">
    ...
    """ % (file_data)
        ...
        model_data_ids = mod_obj.search(
            cr, uid, [('model', '=', 'ir.ui.view'), ('name', '=', 'view_vat_save')], context=context)
